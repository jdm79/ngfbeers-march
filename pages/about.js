      ...
      <div className='w-screen text-black bg-yellow-400 mx-auto px-2 sm:px-0'>
        <div className='justify-center border-2 border-black rounded-lg bg-white mt-12 mb-10 shadow-md shadow-black sm:w-3/4 mx-auto'>
          <p className='p-5 font-courier'>
            This website showcases naturally gluten-free (NGCI) beers and
            ...
            gluten is rarely on sale in any bar or supermarket. Instead, fridges
            and aisles are full of 'gluten-reduced' beers made with barley and badged as
            'gluten-free'. We're not really sure who those beers are really for,
            but they're cheaper to make than beer made{" "}
            <span className="italic">without barley</span> and it's an easier way to make a buck.
            And if the laws in your country allow you to do this - and you're
            not worried about possibly{" "}
            <Link
          ...
          <p className='p-5 font-courier'>
            Beer made with barley, and subsequently treated with enzymes to 'remove' the gluten is - at
            best - gluten-reduced beer. The gluten is not removed, however, only made
